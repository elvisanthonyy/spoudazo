...
const SpoudazoFor = () => {
  return (
    <section className="bg-white text-[#262626] w-full p-[96px]">
      <div className="flex items-between w-full  justify-between">
        <h1 className="text-[48px] tracking-[-2%] leading-[48px] font-bebas w-[228px] text-[#151515]">
          WHO IS SPOUDAZO FOR?
        </h1>
        <div className="text-[32px] flex flex-col gap-8 font-medium tracking-[-2%] leading-[40px] w-[65%]">
          <p>
